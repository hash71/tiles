                            ...
                            <div class="form-bordered">
                                <div class="form-row">
                                  ...
                                  <div class="form-input col-md-4">
                                      <input type="text" name="ref_bill_id" id="refBillId" value="" required />
                                  </div>
                                  ...
                                  <div class="form-input col-md-4">
                                      <input type="text" name="ref_bill_date" class="datepicker" value="" />
                                  </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-label col-md-2">
                                ...
                                <div class="single-product row">
                                    ...
                                    <div class="form-bordered">
                                        <div class="form-row">
                                            ...
                                            <input type="text" id="autocomplete1" name="product_code1">
                                           ...
                                           <div class="form-label col-md-2">
                                            ...
                                            <div class="form-input col-md-2">
                                                <input type="number" class="sft_q" min="1" step="any" name="product_quantity1" id="quantity1" value=""  required />
                                            </div>
                                            ...
                                            <div class="form-input col-md-3">
                                                <input type="number" min="1" step="any" name="unit_sale_price1" id="rate1" value="" required />
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-label col-md-2">
                                            ...
                                            <div class="form-input col-md-3">
                                                <input type="number" min="0" step="any" name="cost1" id="cost1" value="" readonly="true" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="bill-total col-md-10 center-margin">
                            ...
                            <div class="form-bordered">
                                <div class="form-row">
                                    ...
                                    <div class="form-input col-md-2">
                                        <input type="number" min="0" name="less" step="any" id="discount" value="" required />
                                    </div>
                                    ...
                                    <div class="form-input col-md-2">
                                        <input type="number" min="0" name="carryingcost" step="any" id="carryingcost" value="" required />
                                    </div>
...
<script>
    ...
    //sft to piece conversion
        ...
        //$(".single-product input[type=number]").bind('keyup',function(){
    ...
    $('body').on('click','.remove',function(event){
        ...
        $('.single-product').each(function() {
            ...
            var singlecost = $('#cost'+productcount).val();
            totalcost = parseFloat(totalcost) + parseFloat(singlecost);
            productcount++;
        });
        //updating gross and net total after deleteing a product
