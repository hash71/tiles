        ...
        <div class="example-code">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <form name="get-bill"  action="{{ URL::to('return_transaction') }}" method="post" onsubmit="return validate();">
                        <div id="bill">
                            ...
                            <div class="form-bordered">
                                ...
                                <div class="single-product">
                                    <div class="form-row">
                                        ...
                                        <div class="form-input col-md-2">
                                            <input type="text" min="0" name="code0" id="code" value="0" readonly="true" />
                                        </div>
                                        <div class="form-label col-md-2">
                                            <label>
                                                Unit Size:
                                        ...
                                        <div class="form-input col-md-2">
                                            <input type="text" min="0" name="size0" id="size" value="" readonly="true" />
                                        </div>
                                        <div class="form-label col-md-2">
                                            <label for="">
                                                Rate(sft):
                                        ...
                                        <div class="form-input col-md-2">
                                            <input type="number" min="0" name="rate0" id="rate" value="0" readonly="true" />
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-label col-md-2">
                                        ...
                                        <div class="form-input col-md-2">
                                            <input type="number" min="0" name="aa0" id="aa" value="0" readonly="true" />
                                        </div>
                                        <div class="form-label col-md-2">
                                            <label for="">
                                                Return(Pieces):
                                        ...
                                        <div class="form-input col-md-2">
                                            <input class="canreturn" type="number" min="0" name="returnqty0" id="returnqty" value="0" required />
                                        </div>
                                        <div class="form-label col-md-2">
                                            <label for="">
                                                Return(sft):
                                        ...
                                        <div class="form-input col-md-2">
                                            <input class="hisab" type="number" min="0" name="returnsft0" id="returnsft" value="0" readonly="true" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-bordered">
                                    <div class="form-row">
                                        ...
                                        <div class="form-input col-md-4">
                                            <input type="number" min="0" name="due" id="due" value="0" readonly="true" />
                                        </div>
                                        <div class="form-label col-md-2">
                                            <label for="gross">
                                                Moneyback:
                                        ...
                                        <div class="form-input col-md-4">
                                            <input type="number" min="0" name="back" id="back" value="0" readonly="true" />
                                        </div>
                                    </div>
    ...
    $('#bill_id').on('change',function(e){
        ...
        $.post('../rat',bill, function(data){
            ...
            $.each(data[1],function(k,v){
                ...
                $div.find('.canreturn').prop('max',data[1][k]['total_piece']);
