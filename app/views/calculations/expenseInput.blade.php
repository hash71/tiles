        ...
        <div class="example-code">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <form name="get-bill"  action="{{URL::to('store_expense')}}" method="post" onsubmit="return validate();">
                        <div id="bill-total col-md-10 center-margin">
                            <h3 class="content-box-header bg-green">
                                <span class="product-num">Expense Description</span>
                            </h3>
                            ...
                            <div class="form-row pad10A">
                                <div class="form-row col-md-4 col-md-offset-8 ">
                                    <div class="form-label col-md-8">
                                        <input type="submit" value="Add Expense" class="btn primary-bg medium">
                                    </div>
...
$(document).ready(function(){
    ...
    //Preventing double clicking form
